"""
Django settings for ComputerConfigurator project.
...
SECRET_KEY = '87jpo(0l848z@=sib@6o4m10$c9wbs7u2ci4snl_gy*$7un-jw'
...
ROOT_URLCONF = 'ComputerConfigurator.urls'
...
WSGI_APPLICATION = 'ComputerConfigurator.wsgi.application'
